...
class controlGUI:
    ...
    def checkvSet(self):
        ...
        if intFLAG:
            ...
            print "gogogo"
            self._job_vSet=root.after(100,self.checkvSet)
    ...
    def findHome(self):
        #Sample every 100ms
        self._job_findHome = root.after(100,self.findHome)
        self.stat = MOTOR.getSENSORS(0)
    ...
    def cancel(self):
        ...
        if self._job_vSet is not None:
            ...
            self.job_vSet = None
        if self._job_findHome is not None:
            root.after_cancel(self._job_findHome)
            self._job_findHome = None 
