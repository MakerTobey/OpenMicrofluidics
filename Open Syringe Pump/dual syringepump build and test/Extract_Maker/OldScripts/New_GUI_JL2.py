...
class headerBLOCK:
    def __init__(self,master,r,c):
        ...
        self.labelt = Label(self.tit, text="DeRisi Lab Extract Maker", bg='white',fg='#000666000',padx=4,pady=4,width=32,font=self.title,anchor="center")
        self.labelt.grid(sticky=N+E+S+W) 
...
class controlGUI:
    ...
    def __init__(self,master,r,c):
        ...
        ##Home Button
        self.homeButton=Button(self.sm,text="HOME",fg="black",bg="blue",height=6,width=16,command=self.jogHome)
    ...
    def vdefault(self):
        if self.homeComplete:
            #Set volume back to default value of 1.5mL
            self.vStart=1.5
    ...
    def findHome(self):
        ...
        #When both motors are stopped, cancel after function
    ...
    def movement(self):
        ...
        if self.cycleCount < 5:
            ...
            print "No more"
            #GPIO.remove_event_detect(22, GPIO.FALLING, callback=self.moveDone) 
    ...
    def doCycle(self):
        ...
        self._job=root.after(500,self.movement)
    ...
    def stopAll(self):
        ...
        self.cycleCount=0
        self.intReset
        print("Stopping and resetting all processes")
